...
def task_removing():
    try:
        ...
        tkinter.messagebox.showwarning(title="Attentions !! ",message= "To delete a task , you must select a task !!")
...
add_task_button = tkinter.Button(window,text="click to add Task",font=("arial",20,"bold"), background="white", width= 40,command= task_adding)
add_task_button.pack()

remove_task_button = tkinter.Button(window,text="remove to add task",font=("arial",20,"bold"),background="red",width=40, command=task_removing)
remove_task_button.pack()


load_task_button = tkinter.Button(window,text="click to load task",font=("arial",20,"bold"),background="yellow",width=40,command=task_load)
